...
const char* ssid     = "POCO X3 Pro";   //WIFI SSID
const char* password = "qwerty666";   //WIFI password
String token = "5211207712:AAG61hDiAYh6SJ0CPcCKEkam0MijJl64M08";
String chat_id = "1107210082";
...
else 
{
  ...
  if (err != ESP_OK) 
{
    Serial.printf("Camera init failed with errors 0x%x", err);
    delay(1000);
    ESP.restart();
  }
